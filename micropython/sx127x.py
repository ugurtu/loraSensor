...
class SX127x:
    ...
    def __init__(self,
                 name='SX127x',
                 parameters={'frequency': 868E6, 'tx_power_level': 2, 'signal_bandwidth': 250E3,  # 125E3
                             'spreading_factor': 7, 'coding_rate': 8, 'preamble_length': 8, 'gain': 0,
    ...
    def collect_garbage(self):
        gc.collect()
        if configurationlora.IS_MICROPYTHON:
